...
trait CacheHelperTrait{
     ...
     */
    private function _internalTrySingleValue(string $key, Closure $valueFactory, bool $skipCache, mixed $permissionRequired): SuccessResult|ErrorResult|UnauthorizedResult|NotFoundResult{
        if(!$skipCache){
    ...
    private function unknownPermissionSingleValue(string $key, Closure $valueFactory, bool $skipCache){
        return $this->_internalTrySingleValue($key, $valueFactory, $skipCache, null);
    }
